...
class ActionRecommendMovies(Action):
    ...
    def run(self,
      ...
      dispatcher.utter_message("Sure thing! Wait a second...")
      os.chdir("C:\\Users\\shao4\\Documents\\Rasa_Projects\\rasa_chatbot1\\actions\\MovieRec")
      os.system('python get_recommendations.py')
      # os.system('python C:\\Users\\shao4\\Documents\\Rasa_Projects\\rasa_chatbot1\\actions\\MovieRec\\get_recommendations.py')
      # os.system(r"C:\Users\Public\Documents\SampleFile.txt")
      # Some code to run get_recommendations.py
